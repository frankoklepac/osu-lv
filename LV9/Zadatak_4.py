...
""" BASELINE:
    Prestao nakon 16 epoha - najbolji nakon 11te epohe
    Tocnost na testu = 75.86
    Vrijeme po epohi = 11 - 12 s

SMALL BATCH:
    Prestao nakon 18 epoha - najbolji nakon 13te epohe
    Tocnost na testu = 76.49
    Vrijeme po epohi = 15 - 16 s

DIFFERENT LEARNING RATE:
    Korisit se ADAMAX
    Prestao nakon 30 epoha, najtocniji na 25toj
    Tocnost na testu = 77.75
    Vrijeme po epohi = 11 - 12 s

LESS LAYERS:
    Prestao nakon 17 epoha, najtocniji na 12toj
    Tocnost na testu = 71.31
    Vrijeme po epohi = 7-10 s

LESS DATA:
    Prestao nakon 17 epoha, najtocniji na 12toj
    Tocnost na testu = 70.86
